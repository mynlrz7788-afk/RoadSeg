...
class DySnakeConv(nn.Module):
    def __init__(self, inc, ouc, k=3, kDSC=9, act=True) -> None:
        super().__init__()

        self.conv_0 = Conv(inc, ouc, k, act=act)
        self.conv_x = DSConv(inc, ouc, 0, kernel_size=kDSC)  # origin: k
        self.conv_y = DSConv(inc, ouc, 1, kernel_size=kDSC)  # origin: k
